...
// 	// change dposContext
// 	assert.Nil(t, dposContext.BecomeCandidate(common.Hex2Address("Uothis8V2UoJMDJm7CXKMT6PcWc62kw4e")))
// 	dposroot := dposContext.Root()
// 	snaproot := snapshot.Root()

// 	if !common.BytesEquals(dposroot.Bytes(), snaproot.Bytes()) {
// 		t.Errorf("root:%v eq snap:%v", dposroot.Bytes(), snaproot.Bytes())
// 		return
// 	}
...
// 	// assert.NotEqual(t, dposContext, snapshot)
// 	// bs, _ := json.Marshal()
// 	// bs2, _ := json.Marshal(snapshot)
// 	// dposContext := dposContext

// 	if dposContext != snapshot {
// 		t.Errorf("root:%v eq snap:%v", dposroot.Bytes(), snaproot.Bytes())
// 		return
// 	}
// }
