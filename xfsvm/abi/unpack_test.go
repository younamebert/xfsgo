...
func TestMultiReturnWithStringArray(t *testing.T) {
	...
	ret2, ret2Exp := new(common.Address), common.Hex2Address("ab1257528b3782fb40d7ed5f72e624b744dffb2f")
...
func TestUnmarshal(t *testing.T) {
	...
	helloHash := common.Bytes2Hash(common.RightPadBytes([]byte("hello"), 32))
	if hash != helloHash {
